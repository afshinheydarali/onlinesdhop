...
کاربر صریحاً بررسی و برنامهٔ توسعه خواسته است؛ پنج بستهٔ زیر بدون توقف برای انتخاب مجدد آماده شده‌اند. هیچ‌کدام اجرا نشده‌اند. پلن‌های 004 و 005 طرح مرحله‌ای هستند و قبل از پیاده‌سازی وسیع باید vertical slice و قراردادهای خود را تثبیت کنند.

| پلن | وضعیت | وابستگی |
|---|---|---|
| [001 — محیط و تست قابل اتکا](001-verification-baseline.md) | TODO | ندارد |
| [002 — صحت پیش‌نمایش و تأیید](002-draft-integrity.md) | TODO | 001 |
| [003 — بازیابی delivery](003-delivery-recovery.md) | TODO | 001 و 002 |
| [004 — بک‌اند API و PostgreSQL](004-backend-foundation.md) | TODO | 001، 002، 003 |
