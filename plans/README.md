...
| [003 — بازیابی delivery](003-delivery-recovery.md) | IN PROGRESS | 001 و 002 |
| [004 — بک‌اند API و PostgreSQL](004-backend-foundation.md) | IN PROGRESS — API و importer پایه ادغام شد؛ CI و اتصال bot باز است | 001، 002، 003 |
