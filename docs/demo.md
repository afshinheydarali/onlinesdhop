...
This walkthrough uses only the named local synthetic database. Every reset is explicit and guarded. Run the API in one terminal:
...
$env:JWT_SECRET = "local-demo-only"
